...
public class LoginActivity extends BaseActivity {
	...
	protected void initEvents() {
		...
		data = ApplicationData.getInstance();
	...
	private void tryLogin(String account, final String password) {
		new MyTask(account,password).execute();
	}
	...
	private class MyTask extends AsyncTask<Void,Void,Integer>{
		...
		MyTask(String account,String password){
		...
		protected Integer doInBackground(Void... params) {
			NetService mNetService = NetService.getInstance();
			try {
