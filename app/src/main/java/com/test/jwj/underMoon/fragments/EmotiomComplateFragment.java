...
import com.test.jwj.underMoon.CustomView.EmojiIndicatorView;
import com.test.jwj.underMoon.R;
import com.test.jwj.underMoon.adapter.EmotionGridViewAdapter;
import com.test.jwj.underMoon.adapter.EmotionPagerAdapter;
...
public class EmotiomComplateFragment extends BaseFragment {
    ...
    private void initEmotion() {
        // 获取屏幕宽度
        int screenWidth = SystemMethod.getScreenWidthPixels(getActivity());
        // item的间距
        int spacing = SystemMethod.dip2px(getActivity(), 12);
        // 动态计算item的宽度和高度
